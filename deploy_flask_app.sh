...
source /root/hellowold/venv/bin/activate
...
User=root
Group=www-data
WorkingDirectory=/root/hellowold
ExecStart=/root/hellowold/venv/bin/gunicorn --workers 3 --bind unix:/root/hellowold/myflaskapp.sock -m 000 app:app
...
server {
    ...
    location / {
        ...
        proxy_pass http://unix:/root/hellowold/myflaskapp.sock;
    }
}
EOF
